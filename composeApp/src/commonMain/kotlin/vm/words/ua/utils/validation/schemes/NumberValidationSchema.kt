...
import vm.words.ua.utils.validation.actions.NumberRangeAction
...
fun <T> ValidationScheme<T>.isBetweenInclusive(
    min: T,
    max: T
): ValidationScheme<T> where T : Comparable<T>, T : Number {
    return add(
        NumberRangeAction(
