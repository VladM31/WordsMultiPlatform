...
import vm.words.ua.exercise.domain.managers.impls.ExerciseRecommendationManagerImpl
...
internal val managerExerciseModule = DI.Module("managerExerciseModule") {
    ...
    bind<ExerciseRecommendationManager>() with singleton {
        ExerciseRecommendationManagerImpl(
            client = instance(),
            userManager = instance()
        )
    }
