...
/**
 * Заглушка для JVM платформы (Firebase Remote Config не используется на Desktop)
...
actual object AppRemoteConfig {
    ...
    actual suspend fun initialize() {
        println("Firebase Remote Config не используется на Desktop платформе. Используются дефолтные значения.")
    }
